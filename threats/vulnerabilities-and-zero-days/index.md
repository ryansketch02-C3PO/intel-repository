...
| ZD-026 | YellowKey | BitLocker Bypass / WinRE FStX Feature Update Simulation | Windows 11 · Server 2022/2025 (Win10 unaffected) | None — UNPATCHED | 🔴 UNPATCHED **(Day 7; full PoC public; TPM-only confirmed; TPM+PIN unconfirmed)** | 🔴 HIGH — Public PoC; encryption assurance bypass; same researcher as RedSun/UnDefend | 2026-05-13 |
| ZD-027 | GreenPlasma | EoP / CTFMON Arbitrary Section Creation | Windows 11 · Server 2022/2025 | None — UNPATCHED | 🔴 UNPATCHED **(Day 7; partial PoC — SYSTEM shell component withheld)** | 🟡 MEDIUM (🔴 HIGH if completed; cldapi.dll abuse; Nightmare-Eclipse fifth tool) | 2026-05-13 |
| ZD-002 | RedSun | LPE / Cloud Files API + NTFS Junction | Windows 10/11/Server 2019+ | None — UNPATCHED | 🟡 **POTENTIALLY SILENTLY PATCHED** — Researcher claims quiet patch by Microsoft; no CVE; no public advisory; unconfirmed; Day 33 | 🟡 HIGH (WATCH — verify PoC status; do not stand down detections) | 2026-04-18 |
| ZD-003 | UnDefend | DoS / Defender Blind + Telemetry Falsification | Windows 10/11/Server 2019+ | None — UNPATCHED | 🔴 UNPATCHED **(Day 33 — no fix; no CVE; KEV threshold passed)** | 🟡 MEDIUM (🔴 HIGH chained; telemetry manipulation confirmed) | 2026-04-18 |
...
*Last updated: 2026-05-19 | Added ZD-043 (CVE-2026-39987, Marimo unauth RCE, CVSS 9.8, CISA KEV, EPSS 0.818) + ZD-044 (CVE-2026-3854, GitHub Actions RCE, CVSS 8.7, ITW + PoC) + ZD-045 (Apache OFBiz May 2026 batch: CVE-2026-31986 unauth RCE via default JWT + CVE-2026-45434 auth bypass → RCE + CVE-2026-46586 code injection + 5 more, all patched in 24.09.06) + ZD-046 (CVE-2026-42822, Azure Local ALDO EoP, CVSS 10.0); day-counter update: ZD-040 MiniPlasma Day 2; ZD-026 YellowKey Day 7; ZD-027 GreenPlasma Day 7; ZD-003 UnDefend Day 33; ZD-002 RedSun Day 33 — CRITICAL: Researcher claims quiet patch by Microsoft (no CVE, unconfirmed — do not stand down detections pending verification); no new Nightmare-Eclipse tool today (GitHub confirmed at 6 repos); ZD-031 Exchange CVE-2026-42897 CISA KEV deadline May 29 | Entry count: 46*
