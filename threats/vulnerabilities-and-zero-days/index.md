...
|---|---|---|---|---|---|---|---|
| ZD-040 | MiniPlasma | LPE / Race Condition → SYSTEM via `cldflt.sys` | Windows 10 · Windows 11 · Server 2016–2025 (NOT Insider Canary; NOT Win7/8/Server 2008–2012) | CVE-2020-17103 — **PATCH INEFFECTIVE** (original Dec 2020 fix confirmed ineffective/reversed; new CVE pending) | 🔴 UNPATCHED — Works on fully patched May 2026 Win11 KB5089549; Canary NOT affected | 🔴 HIGH — Full public PoC + binary (GitHub); SYSTEM shell from standard user confirmed; 6th Chaotic Eclipse tool; Day 3 | 2026-05-18 |
| ZD-031 | CVE-2026-42897 | XSS / Arbitrary Code Execution via Crafted Email | Microsoft Exchange Server (on-prem, all versions w/ OWA) | CVE-2026-42897 | 🔴 UNPATCHED — Out-of-band mitigations only; CISA KEV deadline May 29 | 🔴 HIGH — Actively exploited; email-borne; OWA session hijack + code execution; Exchange Online NOT affected | 2026-05-15 |
| ZD-026 | YellowKey | BitLocker Bypass / WinRE FStX Feature Update Simulation | Windows 11 · Server 2022/2025 (Win10 unaffected) | None — UNPATCHED | 🔴 UNPATCHED **(Day 8; Microsoft mitigations published May 20; full PoC public; TPM-only confirmed; TPM+PIN unconfirmed)** | 🔴 HIGH — Public PoC; encryption assurance bypass; Microsoft mitigation guidance now available; same researcher as RedSun/UnDefend | 2026-05-13 |
| ZD-027 | GreenPlasma | EoP / CTFMON Arbitrary Section Creation | Windows 11 · Server 2022/2025 | None — UNPATCHED | 🔴 UNPATCHED **(Day 8; partial PoC — SYSTEM shell component withheld)** | 🟡 MEDIUM (🔴 HIGH if completed; cldapi.dll abuse; Nightmare-Eclipse fifth tool) | 2026-05-13 |
| ZD-002 | RedSun | LPE / Cloud Files API + NTFS Junction | Windows 10/11/Server 2019+ | None — UNPATCHED | 🟡 **POTENTIALLY SILENTLY PATCHED** — Researcher claims quiet patch by Microsoft; no CVE; no public advisory; unconfirmed; Day 34 | 🟡 HIGH (WATCH — verify PoC status; do not stand down detections) | 2026-04-18 |
| ZD-003 | UnDefend | DoS / Defender Blind + Telemetry Falsification | Windows 10/11/Server 2019+ | None — UNPATCHED | 🔴 UNPATCHED **(Day 34 — no fix; no CVE; KEV threshold passed)** | 🟡 MEDIUM (🔴 HIGH chained; telemetry manipulation confirmed) | 2026-04-18 |
...
### Recently Added (2026-05-20)

| ID | Name | Type | Platform | CVE | Patch Status | Threat Level | Date Added |
|---|---|---|---|---|---|---|---|
| ZD-047 | ChromaToast | Pre-Auth RCE / Malicious Model Loading before Auth Check | ChromaDB Python FastAPI server 1.0.0–1.5.8 (Rust frontend + local-only deployments NOT affected) | CVE-2026-45829 (CVSS 10.0) | 🔴 UNPATCHED — No official patch or advisory from maintainers; v1.5.9 unconfirmed fix; restrict network access immediately | 🔴 CRITICAL — CVSS 10.0; unauthenticated; 73% of exposed instances vulnerable (HiddenLayer); auth check runs *after* model load — payload fires before auth; full server takeover; API keys, env vars, file system exfiltrated; AI/RAG pipeline threat | 2026-05-20 |
| ZD-048 | Windchill/FlexPLM Zero-Day | Unauthenticated RCE / Java Deserialization via Apache Servlet | PTC Windchill + FlexPLM (all versions exposing vulnerable servlets; customer-managed deployments) | None — No CVE assigned | 🔴 UNPATCHED — Patch not available; workaround: block `/servlet/(WindchillGW|WindchillAuthGW)/com.ptc.wvs.server.publish.Publish` in Apache config | 🔴 CRITICAL — CVSS 10.0 (vendor-assigned); **IoCs confirmed** (web shell uploads post-exploit); no public CVE; Windchill/FlexPLM ubiquitous in aerospace & defense PLM/PDM environments; unauthenticated internet-facing RCE | 2026-05-20 |
| ZD-049 | ScadaBR RCE Cluster | Unauthenticated RCE / Missing Auth + OS Command Injection + CSRF | ScadaBR 1.2.0 (ICS/SCADA HMI platform) | CVE-2026-8602 · CVE-2026-8603 · CVE-2026-8604 · CVE-2026-8605 (CVSS 9.1 each) | ⚠️ PATCH STATUS UNKNOWN — CISA-disclosed; vendor guidance pending; remove external exposure immediately | 🟠 HIGH — CVSS 9.1; CISA-disclosed; ICS/OT targeting; three chainable vuln classes (missing auth + OS command injection + CSRF); exploitation likelihood rated HIGH; no active exploitation confirmed but viable unauth RCE path | 2026-05-20 |
| ZD-050 | NVIDIA Triton Auth Bypass | Authentication Bypass → RCE / EoP / DoS | NVIDIA Triton Inference Server (all affected versions; AI inference infrastructure) | CVE-2026-24207 (CVSS critical) · CVE-2026-24206 (auth bypass) + 10 additional Triton/TRT-LLM CVEs | ⚠️ PATCH STATUS UNCLEAR — NVIDIA security bulletin published May 20; update to latest Triton/TRT-LLM immediately | 🟠 HIGH — Critical auth bypass enabling code execution, EoP, and DoS on AI inference infrastructure; relevant to AI lab and enterprise ML environments; no active exploitation confirmed | 2026-05-20 |
| ZD-051 | Firefox 151 / Thunderbird May 2026 Security Batch | Integer Overflow RCE + Multiple Sandbox Escapes + Memory Safety Bugs | Firefox < 151 · Firefox ESR < 140.11/115.36 · Thunderbird < 151/140.11 | CVE-2026-8956 (CVSS 9.8 — integer overflow, networking) · CVE-2026-8974 (CVSS 9.8 — memory safety) · CVE-2026-8953/8958/8959/8945 (sandbox escapes) + 25+ additional | ✅ PATCHED — Firefox 151 / ESR 140.11 / ESR 115.36; Thunderbird 151 / ESR 140.11 | 🟠 HIGH — Two CVSS 9.8 CVEs; 4 sandbox escape paths; ubiquitous browser; CIS Advisory 2026-052; no active exploitation; patch within 7 days | 2026-05-20 |
...
*Last updated: 2026-05-20 | Added ZD-047 (ChromaToast CVE-2026-45829, CVSS 10.0, pre-auth RCE ChromaDB Python server, no patch, 73% exposed instances vulnerable) + ZD-048 (PTC Windchill/FlexPLM Zero-Day, CVSS 10.0, unauth RCE via Java deserialization, no CVE, IoCs confirmed, no patch) + ZD-049 (ScadaBR CVE-2026-8602–8605, CISA-disclosed ICS/OT unauth RCE cluster, CVSS 9.1) + ZD-050 (NVIDIA Triton CVE-2026-24207, critical auth bypass AI inference infra); day-counter update: ZD-040 MiniPlasma Day 3; ZD-026 YellowKey Day 8 — Microsoft mitigations published May 20 (still unpatched); ZD-027 GreenPlasma Day 8; ZD-003 UnDefend Day 34; ZD-002 RedSun Day 34; ZD-031 Exchange CVE-2026-42897 CISA KEV deadline May 29 — 9 days remaining | + ZD-051 (Firefox 151/Thunderbird May 2026 batch: CVE-2026-8956 CVSS 9.8 integer overflow + CVE-2026-8974 CVSS 9.8 memory safety + 4 sandbox escapes, CIS Advisory 2026-052); Entry count: 51*
