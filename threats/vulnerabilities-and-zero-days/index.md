...
|---|---|---|---|---|---|---|---|
| ZD-040 | MiniPlasma | LPE / Race Condition → SYSTEM via `cldflt.sys` | Windows 10 · Windows 11 · Server 2016–2025 (NOT Insider Canary; NOT Win7/8/Server 2008–2012) | CVE-2020-17103 — **PATCH INEFFECTIVE** (original Dec 2020 fix confirmed ineffective/reversed; new CVE pending) | 🔴 UNPATCHED — Works on fully patched May 2026 Win11 KB5089549 (builds 26100.8457 / 26200.8457); Canary build NOT affected (quiet fix in progress) | 🔴 HIGH — Full public PoC + binary (GitHub); SYSTEM shell from standard user confirmed by BleepingComputer + Dormann; 6th Chaotic Eclipse tool; predecessor tools weaponized by Russia-geolocated actors within 24h | 2026-05-18 |
